...
function castHabiticaSkill(spellId, targetId, doAfter) {
    ...
    axios.post(CAST_URL + spellId + param, {}, {headers: headers}).then(rsp => {
        console.info("success dododododo");
